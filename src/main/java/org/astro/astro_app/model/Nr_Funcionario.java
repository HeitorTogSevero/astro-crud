...
//    Metodo Construtor da Classe Nr_Funcionario:
    public Nr_Funcionario(int idNrFunc, int idNrDescricao, int tempoReciclagem, String titulo, LocalDate dtRealizacao, String status) {
